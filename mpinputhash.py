...
################## target image calculate workload per thread  #################
...
############### Divide total image into number of CPU ################
cpus = mp.cpu_count()
...
################## Print some stats on this job ############

#print 'Workload per thread: ', workload
#print 'Filesizefsize: ', fsize
...
#results = "test" # [output.get() for p in processes]
